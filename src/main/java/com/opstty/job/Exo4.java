...
import com.opstty.mapper.Exo4Mapper;
import com.opstty.reducer.Exo4Reducer;
...
public class Exo4 extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(Exo4Mapper.class);
        job.setReducerClass(Exo4Reducer.class);
